...
config1 = [['gas', 'electro', 'hybrid'], '200 PS', 'radio']
config2 = [['gas', 'electro', 'hybrid'], '200 PS', 'radio']
print(Car.has_same_configuration(config1,config2))
print(is_same_car_color_and_model(c,d))
print(is_same_instance_of_car(c,c))